...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZWtuaXZvYSIsImEiOiJja2NlZDJ1czgwNzU3MnNwYms4amZqZXd0In0.kXjIojq85vsnibTwyOn5Ow';
  var map = new mapboxgl.Map({
    container: 'map',
    //style: 'mapbox://styles/eknivoa/ckcedmihn0kva1ipk21ly70nq',
    style: 'mapbox://styles/eknivoa/ckceogthy14mt1irkr8yd2lvk',
    scrollZoom: false //   center: [-118.911434, 34.405886],
    //   zoom: 10,
    //   interactive: false,
...
var stripe = Stripe('pk_test_51H4WOVH4TGquSrf3mlEEn6aGgsUrX6qynvEJP9aCfoknVd9Ivvm0l5Nn0Ss7SNob7HWFBNV3oNpBIK2fxJfsxYNX00hyc9kHfT');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log(session); //2) Create checkput for + charge credit card
